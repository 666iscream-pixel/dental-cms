...
export interface ApiPriceItemPriceItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Prices for Cennik section';
...
export interface ApiServiceItemServiceItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Services list for Uslugi section';
...
export interface ApiTransformationTransformation
  ...
  info: {
    description: 'Before/after cases for Historia (Metamorphoses) section';
  ...
  attributes: {
    ...
    >;
    photo_after: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    photo_before: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    photo_single: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    type: Schema.Attribute.Enumeration<['slider', 'single']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
